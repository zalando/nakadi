...
public class ExactWeightRebalancerTest {
    ...
    public void rebalanceShouldRemoveDeadSessions() {
        ...
        assertFalse(Stream.of(changeset).filter(p -> p.getState() != Partition.State.ASSIGNED).findAny().isPresent());
        ...
        assertFalse(Stream.of(changeset).filter(p->p.getKey().equals(new Partition.PartitionKey("1", "0"))).findAny().isPresent());
    ...
    public void rebalanceShouldMoveToReassigningState() {
        ...
        assertTrue(changed.getKey().equals(new Partition.PartitionKey("1", "0")) || changed.getKey().equals(new Partition.PartitionKey("1", "1")));
