...
public class NakadiAuditLogPublisherTest {
    ...
    public void testPublishAuditLog() {
        ...
        assertThat(new JSONObject("{\"data_op\":\"C\"," +
                        "\"data\":{\"new_object\":{\"schema\":" +
                        "{\"schema\":\"{ \\\"properties\\\": { \\\"foo\\\": { \\\"type\\\": \\\"string\\\" } } }\"," +
                        "\"created_at\":\"2019-01-16T13:44:16.819Z\",\"type\":\"json_schema\",\"version\":\"1.0.0\"}," +
                        "\"compatibility_mode\":\"compatible\",\"ordering_key_fields\":[]," +
                        ...
                        "\\\"options\\\":{\\\"retention_time\\\":172800000},\\\"authorization\\\":null," +
