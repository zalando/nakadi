...
public class PostSubscriptionControllerTest {
    ...
    public void whenSubscriptionCreationIsDisabledThenCreationFails() throws Exception {
        ...
        when(featureToggleService.isFeatureEnabled(Feature.DISABLE_SUBSCRIPTION_CREATION)).thenReturn(true);
    ...
    public void whenEventTypesIsEmptyThenUnprocessableEntity() throws Exception {
        final SubscriptionBase subscriptionBase = RandomSubscriptionBuilder.builder()
                ...
                .buildSubscriptionBase();
        final Problem expectedProblem = TestUtils.invalidProblem("event_types", "must contain at least one element");
        checkForProblem(postSubscription(subscriptionBase), expectedProblem);
    }
