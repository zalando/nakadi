...
public class SubscriptionTokenListerTest extends AbstractDbRepositoryTest {
    ...
    public void testPagingFullPage() {
        ...
        result = subscriptionTokenLister.listSubscriptions(emptySet(), owiningApp, Optional.empty(), null, 2);
        ...
        result = subscriptionTokenLister.listSubscriptions(emptySet(), owiningApp, Optional.empty(), null, 3);
        assertThat(result.getPrev(), nullValue());
        assertThat(result.getNext(), nullValue());
        assertThat(result.getItems(), equalTo(testSubscriptions));
    }
    ...
    public void testPaging() {
        ...
        // 1. Check that there are no paging links if requested more or equal to current count
        result = subscriptionTokenLister.listSubscriptions(emptySet(), owiningApp, Optional.empty(), null, 7);
        assertThat(result.getPrev(), nullValue());
        assertThat(result.getNext(), nullValue());
        assertThat(result.getItems(), equalTo(testSubscriptions));

        result = subscriptionTokenLister.listSubscriptions(emptySet(), owiningApp, Optional.empty(), null, 8);
        assertThat(result.getPrev(), nullValue());
        assertThat(result.getNext(), nullValue());
        assertThat(result.getItems(), equalTo(testSubscriptions));
        ...
        result = subscriptionTokenLister.listSubscriptions(emptySet(), owiningApp, Optional.empty(), secondPage, 3);
