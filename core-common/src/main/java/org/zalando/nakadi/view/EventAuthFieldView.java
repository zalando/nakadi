...
public class EventAuthFieldView {
    ...
    public EventAuthFieldView() {
    }

    public EventAuthFieldView(final String path, final String type) {
        this.type = type;
        this.path = path;
    }
    ...
    public boolean equals(final Object o) {
        ...
        final EventAuthFieldView that = (EventAuthFieldView) o;
