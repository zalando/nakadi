...
public class HashPartitionStrategyTest {
    ...
    public void canHandleComplexKeys() throws Exception {
        ...
        final String partition = strategy.calculatePartition(PartitionData.fromJson(eventType, event), asList(PARTITIONS));
    ...
    public void whenValidateWithHashPartitionStrategyAndDataChangeEventLookupIntoDataField() throws Exception {
        ...
        assertThat(strategy.calculatePartition(PartitionData.fromJson(eventType, event), ImmutableList.of("p0")), equalTo("p0"));
    }
